...
namespace FDD.OpenAPI.SDKModels.Accounts
{
    ...
    /// 获取企业实名绑定地址
    /// </summary>
    [RemoteService("/accounts/getPersonAndCompanyUnionIdUrl", "POST")]
    public class GetPersonAndCompanyUnionIdUrlRequest : BaseReqeust<GetPersonAndCompanyUnionIdUrlResponse>
    {
